...
namespace BLINK.Tools.EditorExtensions
{
    public class MaterialTilingOffsetCustom : EditorWindow
    {
        ...
        [MenuItem("BLINK/Material Tiling Offset Custom")]
        private static void OpenWindow()
        {
            var window = (MaterialTilingOffsetCustom)GetWindow(typeof(MaterialTilingOffsetCustom), false, "Blink Material Tiling Offset Custom");
        ...
        private void DrawMainWindow()
        {
            ...
            GUILayout.Space(10);
            if (GUILayout.Button("INITIALIZE", GUILayout.MinWidth(150), GUILayout.MinHeight(30), GUILayout.ExpandWidth(true)))
            {
                Init();
            }
            GUILayout.Space(10);
            ...
            GUILayout.Space(10);
            if (GUILayout.Button("CREATE MATERIAL", GUILayout.MinWidth(150), GUILayout.MinHeight(30), GUILayout.ExpandWidth(true)))
            {
                CreateMaterial();
            }

            GUILayout.Space(10);
            if (GUILayout.Button("SAVE SELECTION", GUILayout.MinWidth(150), GUILayout.MinHeight(30), GUILayout.ExpandWidth(true)))
            {
                SaveSelection();
            }
        ...
        private void SaveSelection()
        {
            ...
            {
                // Bu kısmı değiştirdik çünkü artık orijinal sınıf yok.
                // SaveSelection özelleştirilebilir, ancak şu an sadece örnek.
                Debug.Log($"GameObject: {go.name} için xOffset: {GetXOffset()}, yOffset: {yOffset} kaydedildi.");
            }
        }
    }
}
